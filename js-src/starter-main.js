...
require(['js/dcf-notice'], function(DCFNoticeModule) {
  ...
  notice.appendNotice(errorContainer, 'Dynamic Error Message', '<strong>Error:</strong> This is a dynamic error message.');
});
...
// Navigation Example
require(['js/dcf-navMenuToggle', 'js/headroom', 'js/body-scroll-lock'], function(navMenuToggleModule, headroom, bodyScrollLock) {
...
// Autoplay Video Toggle
require(['js/dcf-autoplayVideoToggle'], function(DCFAutoplayVideoToggleModule) {
  const theme = new DCFAutoplayVideoToggleModule.DCFAutoplayVideoToggleTheme();
